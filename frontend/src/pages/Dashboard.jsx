...
const ReportIncidentModal = ({ onClose, onSuccess, userId }) => {
    ...
    const handleContactDetailsChange = (e) => {
        ...
        setForm(p => ({ ...p, contactDetails: value }));
    ...
    const handleSubmit = async () => {
        ...
        const validation = validateContactDetails(form.contactDetails);
        if (!validation.isValid) {
            setError(`Invalid contact details: ${validation.error}`);
            return;
        }
                ...
                <div style={{ padding: '28px 32px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    ...
                    <div>
                        ...
                        <input style={{
                            ...
                            onFocus={e => e.target.style.borderColor = '#ef4444'}
                            onBlur={e => e.target.style.borderColor = contactError ? '#ef4444' : 'var(--border)'} />
                        {contactError && (
