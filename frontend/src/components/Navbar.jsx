        ...
        <nav style={navStyle}>
            <div style={{ display: 'flex', alignItems: 'center' }}>
                <div 
                    ...
                    style={{ margin: 0, marginRight: '30px', color: 'var(--text-main)', cursor: 'pointer', fontSize: '20px', fontWeight: '800', display: 'flex', alignItems: 'center', gap: '10px', letterSpacing: '-0.5px' }}
                >
                ...
                {user.role === 'ROLE_ADMIN' && (
                    ...
                    <Link to="/admin/panel" style={linkStyle('/admin/panel')}>Admin Panel</Link>
                    </>
                )}
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <Link to="/settings" style={{ ...linkStyle('/settings'), padding: '10px', fontSize: '18px', marginRight: '10px' }} title="Settings">
                    ⚙️
                </Link>
